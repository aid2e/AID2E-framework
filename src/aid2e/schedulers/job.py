...
class Job:
    ...
    def __init__(
        ...
        Args:
            ...
            parent_result_parameter_name: Parameter name for parent job results
            return_func_results: Whether to return function results
            with_output_dataset: Whether job produces output dataset
            output_file: Output file path
            output_dataset: Output dataset name
            num_events: Total number of events
            num_events_per_job: Events per job
            with_input_datasets: Whether job uses input datasets
    ...
    def set_parent_results(self, step, objective, job_key, results) -> None:
        ...
        Args:
            step: The step name of the current job
            objective: The objective of the current job
            job_key: The job key of the current job
