"""Minimal Ax optimizer-only DTLZ2 example."""
...
DEFAULT_CONFIG_PATH = REPO_ROOT / "examples" / "dtlz2" / "optimizers" / "dtlz2_ax_optimizer_only.yml"
...
def main(argv: List[str]) -> int:
    ...
    print(f"Optimization iterations: {optimizer_config.n_iterations}")
