"""Simple PyMOO optimizer example using direct DTLZ2 ask/tell evaluation."""
...
def main(argv: List[str]) -> int:
    ...
    print(
        f"\n{'Iter':<6} {'Gen':<6} {'x1':<10} {'x2':<10} {'x3':<10} "
    ...
    results_path = (Path.cwd() / "dtlz2_framework_pymoo_results.json").resolve()
    session_path = (Path.cwd() / "dtlz2_framework_pymoo_session.json").resolve()
